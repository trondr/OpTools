...
namespace trondr.OpTools.Module.Infrastructure.ContainerConfiguration
{
    ...
    public class UsageWriterActorContainerInstaller : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            //Manual registrations
            container.Register(Component.For<UsageWriterActor>().LifestyleTransient().Activator<StrictComponentActivator>());
        }
    }
}